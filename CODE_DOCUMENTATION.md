...
**Auto-Generated Docs (Prevent CI Failures):**
- `CODE_LINE_BY_LINE.md` is auto-generated by `npm run docs:code`
- CI runs `npm run docs:check` and fails if the file index is stale
- Any time files are added/removed/renamed, run `npm run docs:code`
- Commit the updated `CODE_LINE_BY_LINE.md` before pushing
- If CI fails, regenerate docs and push the updated file
