...
function BibleReader({ theme, book, setBook, chapter, setChapter, onSearch, onProfileClick, historyStack, onGoBack }) {
  ...
  // ✅ NEW: SHORTCUT TO CREATE NOTE FROM FLOATING MENU (TOGGLE)
    ...
    <div style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', flexWrap: 'wrap', padding: '10px 0', minHeight: '40px' }}>
            ...
            >
                {COLOR_PALETTE.map(color => (
                    <button 
                        ...
                        style={{ 
                            // ✅ MARKER: Simple border ring if active
                            width: '16px', height: '16px', borderRadius: '50%', 
                            backgroundColor: color.code, 
                            border: activeHighlightColor.code === color.code ? '2px solid #555' : '1px solid #999', 
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <button 
                ...
                className="nav-btn" 
                style={{ 
                    // ✅ FIXED: Always show the active color
                    backgroundColor: activeHighlightColor.code,
                    color: activeHighlightColor.code === '#ffffff' ? '#333' : '#333',
                    // Add a border to indicate it's the highlight button
                    border: `2px solid ${activeHighlightColor.border}`,
